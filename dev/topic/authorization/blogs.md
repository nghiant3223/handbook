...
- [What is Authorization Code?](https://www.oauth.com/oauth2-servers/server-side-apps/authorization-code)
...
- [Call Your API Using the Authorization Code Flow](https://auth0.com/docs/flows/call-your-api-using-the-authorization-code-flow)
- [Call Your API Using the Authorization Code Flow with PKCE](https://auth0.com/docs/flows/call-your-api-using-the-authorization-code-flow-with-pkce)
